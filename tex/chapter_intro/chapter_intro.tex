...
%\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
%   \centering
%   \includegraphics[width=\textwidth]{chapter_intro/plots/sn1994d.jpg} 
%   \caption{HST obsrvations of Supernova 1994D in NGC4526 (NASA/Challis)}
%   \label{fig:sn1994d}
%\end{figure}
...
Supernovae have played a vital role in discovering the current structure of the Universe
