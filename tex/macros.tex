...
\newglossaryentry{besancon}{name=Besan\c{c}on Model, description={Model of stellar population synthesis of the Galaxy, including kinematics.  \url{http://model.obs-besancon.fr/} }, nonumberlist=true}
...
\newglossaryentry{cowd}{name=Carbon/Oxygen (CO), text={CO-WD}, description={Carbon/Oxygen White Dwarf}, first={carbon/oxygen White Dwarf (CO-WD)}, parent=wd}
...
%common papers
\newglossaryentry{rp04}{name=RP04, text={RP04}, description={short for \citet{2004Natur.431.1069R}}, first={\citet{2004Natur.431.1069R} (RP04)}}
\newcommand{\rl}{\gls{rp04}}
\newglossaryentry{gh09}{name=GH09, text={GH09}, description={short for \citet{2009ApJ...691....1G}}, first={\citet{2009ApJ...691....1G} (GH09)}}
\newcommand{\gh}{\gls{gh09}}
\newglossaryentry{wek09}{name=WEK09, text={WEK09}, description={short for \citet{2009ApJ...701.1665K}}, first={\citet{2009ApJ...701.1665K} (WEK09)}}
\newcommand{\wek}{\gls{wek09}}
...
%dalek chapter
\newglossaryentry{ga}{name=GA,description={genetic algorithm}, nonumberlist=true}

\newglossaryentry{individual}{name=individual,description={single representation of a parameter set}, parent=ga}
\newglossaryentry{gene}{name=gene, description={Genetic Algorithm term for an individual parameter}, parent=ga}
\newglossaryentry{genome}{name=genome,description={describes the parameter set of an indivdual}, parent=ga}
\newglossaryentry{fitness}{name=fitness,description={goodness of fit term in Genetic Algorithms}, parent=ga}
\newglossaryentry{genotype}{name=genotype,description={vectorized representation of the parameters}, parent=ga}
\newglossaryentry{phenotype}{name=phenotype,description={solution to a set of parameters}, parent=ga}
\newglossaryentry{crossover}{name=crossover,description={binary operator to create new individual from two or more old individuals}, parent=ga}
\newglossaryentry{mutation}{name=mutation,description={unary operator to alter a newly created individual}, parent=ga}
\newglossaryentry{child}{name=child, plural=children, description={member of the new generation created by parents (members of the old generation)}, parent=ga}
\newglossaryentry{parent}{name=parent, description={member of the old generation creating a child (member of the next generation)}, parent=ga}
...
\newglossaryentry{superindividual}{name=superindividual, text=\textit{superindividual},description={Individual with extremely high fitness, which has only one parameter close to optimal}, sort=superindividual, parent=ga}
\newglossaryentry{elitism}{name={elitism},description={certain percentage of the fittest \glspl{individual} advance unaltered to the next generation}, parent=ga}
\newglossaryentry{rws}{name={roulette~wheel~selection},description={special selection function in Genetic algorithms see Figure~\vref{fig:roulettewheel}}, parent=ga}%, first={roulette wheel selection (RWS)}}
...
\newglossaryentry{vph}{name={photospheric velocity~}, text={photospheric velocity} , symbol={\ensuremath{v_\textrm{ph}}}, description={photospheric velocity of a supernova}, sort=vph}
\newcommand{\vph}{\glssymbol*{vph}}
