...
\newcommand{\thesisdate}{August 2011}
...
\begin{titlepage}\usefont{OT1}{qbk}{m}{n}\selectfont
 ...
 \vspace{0cm}
   ...
   \\[4.cm]
    ...
    \\[5mm]
       \LARGE{Research School of Astronomy \& Astrophysics}\\[5mm]
       \LARGE{\thesisdate}\\[6mm]
       \setlength\fboxsep{3mm}
       \setlength\fboxrule{1pt}
       \framebox{\huge{\textsc{Examination Copy}}}
       %\Large{First submitted \thesisdate}\\[1mm]
       %\Large{Resubmitted with corrections \resubmissiondate}
 \end{center}
\end{titlepage}
...
\include{chapter_sn1572_starg/chapter_sn1572_starg}
\include{chapter_sn1572_hires/chapter_sn1572_hires}
\include{chapter_sn1006/chapter_sn1006}
\include{chapter_dalek/chapter_dalek}
...
\begin{appendices}
%\appendixpage
\include{chapter_ndinterp/chapter_ndinterp}
\include{chapter_ga/chapter_ga}
\include{chapter_sn1006/chapter_sn1006_appendix}
\end{appendices}
\end{document}
